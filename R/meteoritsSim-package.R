...
#'
#' @description `meteoritsSim` is a package containing several original and
...
#'
#' `meteoritsSim` contains the following Mixture-of-Experts models:
#'
#' \itemize{
...
#'
#' To learn more about `meteoritsSim`, start with the vignettes:
#' `browseVignettes(package = "meteoritsSim")`
#'
#' @references
#'
...
#' @useDynLib meteoritsSim, .registration = TRUE
